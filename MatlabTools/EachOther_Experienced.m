...
b = load("../DataSets/ExperiencedAgent4.txt"); % Observing experienced agent
c = load("../DataSets/EachOtherAgent2.txt"); % Observing inexperienced agent
size(a)
size(b)
a = a(:,1:showSize);
b = b(:,1:showSize);
...
legend('Pure DRL Agent','SLDRL Agent - Experienced Agent','SLDRL Agent - Inexperienced Agent');
xlabel('Time');
