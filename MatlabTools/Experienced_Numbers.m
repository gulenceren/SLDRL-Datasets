...
b = load('../DataSets/ExperiencedMove2.txt'); % Number of triggered enact behaviors - observing an inexperienced agent
a = a(:,1:showSize);
figure;
...
title('Triggered behaviors - Observing Experienced Agent');
