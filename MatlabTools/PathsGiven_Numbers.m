lineSize = 2;
showSize = 100;
a = load('../DataSets/8PathsCopy1.txt'); % Number of triggered imitate behaviors - observing pre-defined trajectories
...
title('Triggered behaviors - Predefined Trajectories');
