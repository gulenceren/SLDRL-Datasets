...
allReward2(1:40,:) = data.allRewardsSLDRL;

data2 = load("DQN2/SLDRL_MultiResults.mat");
allReward1(41:60,:) = data2.allRewardsDQN;
allReward2(41:60,:) = data2.allRewardsSLDRL;

data3 = load("DQN3/SLDRL_MultiResults.mat");
allReward1(61:100,:) = data3.allRewardsDQN;
allReward2(61:100,:) = data3.allRewardsSLDRL;
